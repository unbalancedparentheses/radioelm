...
Elm.Radio.make = function (_elm) {
   ...
   var radios = _L.fromArray([A3(radio,
                             "mitre",
                             "http://buecrplb01.cienradios.com.ar/mitremdz.mp3",
                             {ctor: "_Tuple3"
                             ,_0: 17
                             ,_1: 63
                             ,_2: 140})
         ...
         {case "_Tuple2":
            return function () {
                 ...
                 return $Graphics$Element.flow($Graphics$Element.down)($List.map(function (r) {
                    ...
                    r);
                 })(chunk(numberofcards)($List.append(_L.fromArray([A3(controls,
                 _v12._0,
                 _v12._1,
