...
Elm.Radio = Elm.Radio || {};
Elm.Radio.make = function (_elm) {
   "use strict";
   _elm.Radio = _elm.Radio || {};
   if (_elm.Radio.values)
   return _elm.Radio.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   ...
   model) {
      return function () {
         ...
         {case "Click":
            ...
            case "Control":
            return function () {
                 var playing = model.playing ? false : true;
   ...
   var Control = {ctor: "Control"};
   var actions = $Signal.mailbox(Control);
   var Click = function (a) {
      return {ctor: "Click",_0: a};
   };
   var cards = function (x) {
      return _U.cmp(x,
      300) < 0 ? 1 : _U.cmp(x,
      600) < 0 ? 2 : _U.cmp(x,
      850) < 0 ? 3 : 4;
   ...
   var txt = function (string) {
      return $Graphics$Element.centered($Text.typeface(_L.fromArray(["sans-serif"
                                                                    ,"helvetica"]))($Text.height(25)($Text.color($Color.white)($Text.fromString(string)))));
   };
   var control = F3(function (x,
   y,
   playing) {
      return function () {
         var numberofcards = cards(x);
         var xSize = x / numberofcards | 0;
         var ySize = y / numberofcards | 0;
         var text = playing ? "pause" : "play";
         return $Graphics$Input.clickable(A2($Signal.message,
         actions.address,
         Control))($Graphics$Element.color($Color.black)(A4($Graphics$Element.container,
         xSize,
         ySize,
         $Graphics$Element.middle,
         A2($Graphics$Element.flow,
         $Graphics$Element.down,
         _L.fromArray([txt(text)])))));
      }();
   });
   var square = F3(function (x,
   y,
   radio) {
      return function () {
         var numberofcards = cards(x);
         ...
         return $Graphics$Input.clickable(A2($Signal.message,
         actions.address,
         Click(radio)))($Graphics$Element.color(radio.color)(A4($Graphics$Element.container,
         xSize,
         ySize,
         $Graphics$Element.middle,
         A2($Graphics$Element.flow,
         $Graphics$Element.down,
         _L.fromArray([txt(radio.name)])))));
      }();
   });
   var chunk2 = F3(function (acc,
   n,
   list) {
      return function () {
         switch (list.ctor)
         ...
         return function () {
            var newList = A2($List.drop,
            n,
            list);
            var aux = A2($List.take,n,list);
            return A3(chunk2,
            A2($List._op["::"],aux,acc),
            n,
            newList);
   ...
   var radios = _L.fromArray([A3(radio,
                             "mitre",
                             "http://buecrplb01.cienradios.com.ar/Mitre790.aac",
                             {ctor: "_Tuple3"
                             ,_0: 17
                             ,_1: 63
                             ,_2: 140})
                             ,A3(radio,
                             "continental",
                             "http://1351.live.streamtheworld.com:80/CONTINENTAL_SC",
                             {ctor: "_Tuple3"
                             ,_0: 241
                             ,_1: 141
                             ,_2: 5})
                             ,A3(radio,
                             "metro",
                             "http://108.166.161.217:8615/metro.mp3",
                             {ctor: "_Tuple3"
                             ,_0: 0
                             ,_1: 161
                             ,_2: 203})
                             ,A3(radio,
                             "radio argentina",
                             "http://wmserver3.aginet.com.ar:13574/;stream/1/",
                             {ctor: "_Tuple3"
                             ,_0: 97
                             ,_1: 174
                             ,_2: 36})
                             ,A3(radio,
                             "los 40",
                             "http://5133.live.streamtheworld.com:80/LOS40_ARGENTINA_SC",
                             {ctor: "_Tuple3"
                             ,_0: 208
                             ,_1: 209
                             ,_2: 2})
                             ,A3(radio,
                             "la 100",
                             "http://buecrplb01.cienradios.com.ar/la100.aac",
                             {ctor: "_Tuple3"
                             ,_0: 50
                             ,_1: 116
                             ,_2: 44})
                             ...
                             ,A3(radio,
                             "imagina",
                             "http://7309.live.streamtheworld.com:80/IMAGINA_ARGENTINA_SC",
                             {ctor: "_Tuple3"
                             ,_0: 229
                             ,_1: 64
                             ,_2: 40})
                             ...
                             ,A3(radio,
                             "del plata",
                             "http://bel-se-1.se.amdelplata.activecds.telecomcdn.com.ar/amdelplata.mp3",
                             {ctor: "_Tuple3"
                             ,_0: 97
                             ,_1: 97
                             ,_2: 97})
                             ,A3(radio,
                             "cadena 3",
                             "http://coe-se-2.se.cadena3.activecds.telecomcdn.com.ar/am700.mp3",
                             {ctor: "_Tuple3"
                             ,_0: 60
                             ,_1: 181
                             ,_2: 181})
                             ...
                             ,A3(radio,
                             "nova",
                             "http://buecrplb01.cienradios.com.ar/fm979.mp3",
                             {ctor: "_Tuple3"
                             ,_0: 142
                             ,_1: 68
                             ,_2: 35})
                             ,A3(radio,
                             "sonic",
                             "http://live.chicago.cdn.sonic.fm:8000/live128",
                             {ctor: "_Tuple3"
                             ,_0: 215
                             ,_1: 0
                             ,_2: 96})
                             ,A3(radio,
                             "el mundo",
                             "http://radiostream.elmundoradio.com:8332/;",
                             {ctor: "_Tuple3"
                             ,_0: 50
                             ,_1: 116
                             ,_2: 44})]);
   var initialName = function () {
      var _v8 = $List.head(radios);
      switch (_v8.ctor)
      {case "Just":
         return _v8._0.name;
         case "Nothing": return "";}
   ...
   initialState,
   actions.signal);
   var name = Elm.Native.Port.make(_elm).outboundSignal("name",
   function (v) {
      return {name: v.name
             ,url: v.url
             ,playing: v.playing};
   ...
   _v12) {
      return function () {
         ...
         {case "_Tuple2":
            return function () {
                 var numberofcards = cards(_v12._0);
                 return $Graphics$Element.flow($Graphics$Element.down)($List.map(function (r) {
                    return A2($Graphics$Element.flow,
                    $Graphics$Element.right,
                    r);
                 })(chunk(numberofcards)($List.append(_L.fromArray([A3(control,
                 _v12._0,
                 _v12._1,
                 state.playing)]))(A2($List.map,
                 function (r) {
                    return A3(square,
                    _v12._0,
                    _v12._1,
